      ...
      <RevealOnScroll>
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            "
            >
              <h3 className="text-xl font-bold mb-2">Explorer Lab #01</h3>
              <p className="text-gray-400 mb-4">
                Rocketpay is a component that simulates a credit card form, allowing input masking and updating HTML elements via the DOM. The project was developed as part of the Explorer Lab program, which aims to provide practical experience in web development.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["HTML and CSS", "JavaScript e JSON", "TypeScript"].map((tech, key) => (
                  <span
                    key={key}
                    className="
                      bg-blue-500/10 text-blue-500 py-1 px-3 
              ...
              <div className="flex flex-col">
                <a
                  href="https://explorer-lab-neon-nine.vercel.app/"
                  target="_blank"
                  className="text-blue-400 hover:text-blue-300 transition-colors mt-4 mb-2"
                >
                  View Project →
                ...
                <a
                  href="https://github.com/diegobonze/explorer-lab"
                  target="_blank"
                  className="text-blue-400 hover:text-blue-300 transition-colors mt-2 mb-4"
                >
                  View project on GitHub →
